...
Mar 23. Added percentile estimates to avoid 0 and linear transform formula outputs for 8bit and 16bit so that nnstreamer can use them.
...
def boson_show_telemetry(camera_number=0, width=640, height=514, prefix=""):
...
boson_show_telemetry(0, 320, 256, "images/boson_320x256")
